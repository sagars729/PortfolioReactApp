...
function Summary(){
	return (
		<div id="summary" className="primary-theme z-depth-2" >
			...
			<p className="flow-text body_text secondary-theme-text">
				Welcome to my landing page! This website is created with ReactJS, Material UI, MatrealizeCSS and running serverlessly on AWS using CloudFormation, S3, Route 53, ACM, and CloudFront. If you are interested can find the repository for this website <a href="https://github.com/sagars729/PortfolioReactApp" className="tertiary-theme-text">here</a>, the CDK <a href="https://github.com/sagars729/PortfolioCDK" className="tertiary-theme-text">here</a>, and the CI/CD pipeline <a href="https://github.com/sagars729/PortfolioPipeline" className="tertiary-theme-text">here</a>.</p>
			<Typography>
